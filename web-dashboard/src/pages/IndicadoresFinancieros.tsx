                ...
                <Paper elevation={3} sx={{ p: 4, mt: 4 }}>
                    ...
                    <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 4 }}>
                        {indicadoresList.map((item) => {
                            ...
                            return (
                                <Box key={item.key} sx={{ width: { xs: '100%', sm: 'calc(50% - 16px)', md: 'calc(33.33% - 22px)' } }}>
                                    <Card sx={{ borderTop: `5px solid ${color}`, transition: '0.3s', '&:hover': { transform: 'scale(1.02)', boxShadow: 6 }, height: '100%' }}>
                                        <CardContent>
